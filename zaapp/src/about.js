          ...
          <div className="container box-width">
            <div>
              ...
              <p className="meal-attribute">
                At Zaapp, our mission is to transform the financial experiences
                of millions. We aim to provide a seamless, secure, and
                innovative platform to help individuals achieve their goals, one
                transaction at a time.
              </p>
            </div>
            <div>
              <h2 className="heading-secondary">Our Journey</h2>
              <p className="meal-attribute">
                Founded in 2024, Zaapp began as a small startup with a big
                vision: to make banking and saving easier for everyone. Today,
                we are a global team of passionate innovators helping over
                100,000 customers achieve their financial dreams.
              </p>
            </div>
            <div>
              <h2 className="heading-secondary">Why Choose Us?</h2>
              <ul className="in-pairs meal-attribute">
                <li>&#8211; Secure transactions</li>
                <li>&#8211; Innovative savings tools</li>
